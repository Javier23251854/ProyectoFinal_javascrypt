...
fila.append(celdaEstudiante, celdaPrograma, celdaNotas, celdaPromedio, celdaEstado, celdaAccion);
return fila;
}
...
document.querySelector("#promedioGrupal").textContent = formateadorPromedio.format(resumen.promedioGrupal);
...
document.querySelector("#resumenVisible").textContent = `${visibles.length} estudiante${visibles.length === 1 ? "" : "s"}`;
