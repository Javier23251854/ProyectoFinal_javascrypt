...
export class AnalizadorAcademico {
    ...
    filtrar(filtros = {}) {
        ...
        const encontrados = this.#estudiantes.filter(estudiante => {
            const coincideEstado = filtros.estado === undefined ||
    ...
    programas() {
        return [
            ...new Set(this.#estudiantes.map(estudiante => estudiante.programa))
        ].toSorted(comparador.compare);
    }
}
//# sourceMappingURL=AnalizadorAcademico.js.map